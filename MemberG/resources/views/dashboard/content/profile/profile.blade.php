        ...
        <div class="card-body">
          ...
          <div class="cap">
            ...
            <img src="{{asset('assets/header.jpg')}}" alt="Member" class="card-member-bg">
              ...
              @if (auth()->user()->photo_images)
                <img src="{{asset(auth()->user()->photo_images)}}" alt="" class="card-member-avatar">
              @else
                <img src="{{asset('assets/avatar.jpg')}}" alt="" class="card-member-avatar">

              @endif
              <h6 class="card-member-name"> {{auth()->user()->name}} </h6>
              @if (auth()->user()->load('member')->jenis_kelamin=="laki")
